...
# SAPORRA não rodou na minha máquina!!!
...
with open('R_problema01.txt', 'r') as arquivo: 
...
with open('R_problema01.txt', 'w') as arquivo: #Esse 'w' é de write, ou seja, está escrevendo no arquivo
