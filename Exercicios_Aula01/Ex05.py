...
# Fórmula: n/2 e (n/2)+1. Logo a mediana será a média desses valores que estão nessas posições. 
# n é a quantidade de elementos 
...
if n % 2 == 0: #se a quantidade de elementos da lista for par (volte ao Ex04 que tem explicações sobre ser par)
    ...
    #como o primeiro índice é 0, temos que voltar uma posição, pois a quantidade começa a contar de 1,2,3..., diferente os índices de python que começam em 0,1,2...
...
print(f'Mediana é: {mediana}') #outra forma de mostrar em python.